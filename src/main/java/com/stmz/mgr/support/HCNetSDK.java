...
public interface HCNetSDK extends StdCallLibrary {
    ...
    static String PATH_WIN = System.getProperty("user.dir") + File.separator + "lib" + File.separator + "HCNetSDK";
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(PATH_WIN, HCNetSDK.class);
    /***宏定义***/
    //常量
...
//预览相关接口
 ...
 int  NET_DVR_RealPlay_V40(int lUserID, NET_DVR_PREVIEWINFO lpPreviewInfo, FRealDataCallBack_V30 fRealDataCallBack_V30,
                           Pointer pUser);
